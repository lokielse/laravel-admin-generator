...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ asset("{$assetsDir}/admin-lte/dist/css/AdminLTE.min.css") }}" rel="stylesheet">
    <link href="{{ asset("{$assetsDir}/admin-lte/dist/css/skins/_all-skins.min.css") }}" rel="stylesheet">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="http://tp3.sinaimg.cn/1678105910/180/5665221605/0"
                                                     class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="http://tp3.sinaimg.cn/1678105910/180/5665221605/0" class="user-image"
                                 alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="http://tp3.sinaimg.cn/1678105910/180/5665221605/0" class="img-circle"
                                     alt="User Image">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="http://tp3.sinaimg.cn/1678105910/180/5665221605/0" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu" ng-controller="MenuController" ng-cloak id="sidebar">
                <li ng-repeat="menu in menus" ng-class="{header:menu.header}">
                    <div ng-if="menu.header">@{{menu.title}}</div>
                    <a ui-sref="@{{menu.state}}" ng-if="!menu.header && menu.state" ui-sref-active="active">
                        <i class="fa fa-@{{menu.icon}} fa-fw"></i>
                        <span>@{{menu.title}}</span>
                        <i class="fa fa-angle-left pull-right" ng-show="menu.menus.length"></i>
                    </a>
                    <a ng-href="#" ng-if="!menu.header && !menu.state">
                        <i class="fa fa-@{{menu.icon}} fa-fw"></i>
                        <span>@{{menu.title}}</span>
                        <i class="fa fa-angle-left pull-right" ng-show="menu.menus.length"></i>
                    </a>
...
<script src="{{ asset("{$assetsDir}/admin-lte/plugins/slimScroll/jquery.slimscroll.min.js") }}"></script>
...
<script src="{{ asset("{$assetsDir}/admin-lte/dist/js/app.min.js") }}"></script>
